...
window.TACHELES_CONTENT = {
  ...
  items: [
    ...
    { id: "let_shin",   type: "letter", he: "ש", niqqud: "ש", translit: "schin",   de: "Schin – sch/s",             speak: "שִׁין",   theme: "alefbet", freq: 1, note: "שׁ = sch (Punkt rechts), שׂ = s (Punkt links). Erster Buchstabe von שלום" },
    { id: "let_lamed",  type: "letter", he: "ל", niqqud: "ל", translit: "lamed",   de: "Lamed – l",                 speak: "לָמֶד",   theme: "alefbet", freq: 1, note: "ragt als einziger nach oben heraus" },
    { id: "let_vav",    type: "letter", he: "ו", niqqud: "ו", translit: "waw",     de: "Waw – w / o / u",           speak: "וָו",    theme: "alefbet", freq: 1, note: "auch Vokalträger für o und u. Ähnlich: ז und Endform ן" },
    { id: "let_mem",    type: "letter", he: "מ", niqqud: "מ", translit: "mem",     de: "Mem – m",                   speak: "מֵם",    theme: "alefbet", freq: 2, note: "am Wortende: ם" },
    { id: "let_mem_s",  type: "letter", he: "ם", niqqud: "ם", translit: "mem sofit", de: "Mem (Endform) – m",       speak: "מֵם סוֹפִית", theme: "alefbet", freq: 2, note: "nur am Wortende, wie in שלום. Ähnlich: ס" },
    { id: "let_tav",    type: "letter", he: "ת", niqqud: "ת", translit: "taw",     de: "Taw – t",                   speak: "תָּו",    theme: "alefbet", freq: 2, note: "erster Buchstabe von תודה. Ähnlich: ח" },
    { id: "let_dalet",  type: "letter", he: "ד", niqqud: "ד", translit: "dalet",   de: "Dalet – d",                 speak: "דָּלֶת",   theme: "alefbet", freq: 3, note: "Ähnlich: ר (Dalet hat eine Ecke, Resch ist rund)" },
    { id: "let_he",     type: "letter", he: "ה", niqqud: "ה", translit: "he",      de: "He – h",                    speak: "הֵא",    theme: "alefbet", freq: 3, note: "am Wortende oft stumm (a-Laut). Ähnlich: ח (He hat links eine Lücke)" },
    { id: "let_alef",   type: "letter", he: "א", niqqud: "א", translit: "alef",    de: "Alef – stumm (Vokalträger)",speak: "אָלֶף",   theme: "alefbet", freq: 3, note: "trägt Vokale wie a/e, z. B. in אני (ich)" },
    { id: "let_kaf",    type: "letter", he: "כ", niqqud: "כ", translit: "kaf",     de: "Kaf – k / ch",              speak: "כָּף",    theme: "alefbet", freq: 4, note: "mit Punkt (כּ) = k, ohne = ch. Endform: ך. Ähnlich: ב" },
    { id: "let_nun",    type: "letter", he: "נ", niqqud: "נ", translit: "nun",     de: "Nun – n",                   speak: "נוּן",   theme: "alefbet", freq: 4, note: "am Wortende: ן, wie in כן (ja)" },
    { id: "let_nun_s",  type: "letter", he: "ן", niqqud: "ן", translit: "nun sofit", de: "Nun (Endform) – n",       speak: "נוּן סוֹפִית", theme: "alefbet", freq: 4, note: "nur am Wortende. Ähnlich: ו (länger nach unten)" },
    { id: "let_bet",    type: "letter", he: "ב", niqqud: "ב", translit: "bet",     de: "Bet – b / w",               speak: "בֵּית",   theme: "alefbet", freq: 5, note: "mit Punkt (בּ) = b, ohne = w. Ähnlich: כ (Bet hat unten eine Ecke)" },
    { id: "let_qof",    type: "letter", he: "ק", niqqud: "ק", translit: "qof",     de: "Qof – k",                   speak: "קוֹף",   theme: "alefbet", freq: 5, note: "wie in קפה (Kaffee)" },
    { id: "let_yod",    type: "letter", he: "י", niqqud: "י", translit: "jod",     de: "Jod – j / i",               speak: "יוֹד",   theme: "alefbet", freq: 5, note: "kleinster Buchstabe, auch Vokalträger für i" },
    { id: "let_resh",   type: "letter", he: "ר", niqqud: "ר", translit: "resch",   de: "Resch – r",                 speak: "רֵישׁ",   theme: "alefbet", freq: 6, note: "rund. Ähnlich: ד (das hat eine Ecke)" },
    { id: "let_ayin",   type: "letter", he: "ע", niqqud: "ע", translit: "ajin",    de: "Ajin – stumm (Kehllaut)",   speak: "עַיִן",   theme: "alefbet", freq: 6, note: "wie in ערב (Abend)" },
    { id: "let_chet",   type: "letter", he: "ח", niqqud: "ח", translit: "chet",    de: "Chet – ch (wie „Bach“)",   speak: "חֵית",   theme: "alefbet", freq: 6, note: "Ähnlich: ה (Chet ist geschlossen) und ת" },
    { id: "let_pe",     type: "letter", he: "פ", niqqud: "פ", translit: "pe",      de: "Pe – p / f",                speak: "פֵּא",    theme: "alefbet", freq: 7, note: "mit Punkt (פּ) = p, ohne = f. Endform: ף" },
    { id: "let_tet",    type: "letter", he: "ט", niqqud: "ט", translit: "tet",     de: "Tet – t",                   speak: "טֵית",   theme: "alefbet", freq: 7, note: "wie in טוב (gut)" },
    { id: "let_zayin",  type: "letter", he: "ז", niqqud: "ז", translit: "sajin",   de: "Sajin – s (stimmhaft)",     speak: "זַיִן",   theme: "alefbet", freq: 7, note: "wie s in „Rose“. Ähnlich: ו" },
    { id: "let_gimel",  type: "letter", he: "ג", niqqud: "ג", translit: "gimel",   de: "Gimel – g",                 speak: "גִּימֶל",  theme: "alefbet", freq: 8 },
    { id: "let_tsadi",  type: "letter", he: "צ", niqqud: "צ", translit: "zade",    de: "Zade – z (ts)",             speak: "צָדִי",   theme: "alefbet", freq: 8, note: "Endform: ץ" },
    { id: "let_samech", type: "letter", he: "ס", niqqud: "ס", translit: "samech",  de: "Samech – s",                speak: "סָמֶךְ",   theme: "alefbet", freq: 8, note: "Ähnlich: Endform ם (Samech ist rund)" },
    { id: "let_kaf_s",  type: "letter", he: "ך", niqqud: "ך", translit: "kaf sofit", de: "Kaf (Endform) – ch",      speak: "כָּף סוֹפִית", theme: "alefbet", freq: 9, note: "nur am Wortende, wie in שלך (dein)" },
    { id: "let_pe_s",   type: "letter", he: "ף", niqqud: "ף", translit: "pe sofit",  de: "Pe (Endform) – f",        speak: "פֵּא סוֹפִית", theme: "alefbet", freq: 9, note: "nur am Wortende, wie in כסף (Geld)" },
    { id: "let_tsadi_s",type: "letter", he: "ץ", niqqud: "ץ", translit: "zade sofit",de: "Zade (Endform) – z",      speak: "צָדִי סוֹפִית", theme: "alefbet", freq: 9, note: "nur am Wortende" },
